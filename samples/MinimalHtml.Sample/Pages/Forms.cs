...
public class Forms
{
    ...
    private static readonly Template<FormModel.SubGroupsType> RenderGroup = (page, group) => page.Html($"""
    <fieldset>
    ...
    private static readonly Template<FormModel?> Render = (page, model) =>
    {
        var parsed = model;
        model ??= new();
        return page.Html($"""
    ...
    private static readonly Template<FormModel?> RenderParsed = (page, parsed) => parsed == null ? default : page.Html($"""
    <fieldset id="results">

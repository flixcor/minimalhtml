...
{
    private static readonly Template<SampleColumnRowData> Row = (page, data) => page.Html($"""
        <tr>
    ...
    private static readonly Template<IAsyncEnumerable<SampleColumnRowData>> Page = (page, rows) => page.Html($"""
         <h2>Streaming</h2>
         <table>
